			...
			<CardBody>
				<div className="space-y-4">
					...
					<div>
						<label
							className="block text-sm font-medium mb-2"
							htmlFor="result-expire-cron-schedule"
						>
						...
						/>
						<p className="text-xs text-gray-500 mt-1">
							Cron expression for when to run result cleanup (e.g., &quot;0 2 *
							* *&quot; for daily at 2 AM)
						</p>
					</div>
					...
					<div>
						<label
							className="block text-sm font-medium mb-2"
							htmlFor="report-expire-cron-schedule"
						>
						...
						/>
						<p className="text-xs text-gray-500 mt-1">
							Cron expression for when to run report cleanup (e.g., &quot;0 3 *
							* *&quot; for daily at 3 AM)
						</p>
					</div>
