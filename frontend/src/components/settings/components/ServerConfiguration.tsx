		...
		<Card className="mb-6 p-4">
			...
			>
				...
				{editingSection !== "server" ? (
					<Button
						color="primary"
						isDisabled={editingSection !== "none"}
						onPress={onEdit}
					>
						{editingSection === "none"
							? "Edit Configuration"
				...
				<div className="space-y-4">
					<div>
						...
						<Input
							...
							onChange={(e) =>
								editingSection === "server" &&
								onUpdateTempConfig({ title: e.target.value })
							}
						/>
					</div>
					...
					<div>
						...
						<p className="text-xs text-gray-500 mt-1">
							Paths to custom Playwright reporter files (relative to project
							root)
						</p>
					</div>
						...
						<div className="space-y-2">
							{Object.entries(
								...
								.map(([key, value]) => {
									...
									const canReset = ["github", "telegram", "discord"].includes(
										key,
									);
										...
										<div key={key} className="flex gap-2 items-center">
											...
											{editingSection === "server" && canReset && (
												<Button
													...
													size="sm"
													onPress={() =>
														updateHeaderLink(key, defaultLinks[key] || "")
													}
												>
													Reset
												</Button>
