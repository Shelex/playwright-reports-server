...
import type { ReadResultsOutput, Result } from "../types";
...
export default function ResultsTable({
	...
	const {
		...
		error,
		refetch,
	} = useQuery<ReadResultsOutput>(
		withQueryParams(resultListEndpoint, getQueryParams()),
		{
	...
	const onChangeSelect = (keys: Selection) => {
		...
		const selectedResults =
			results?.filter((r) => selectedKeys.includes(r.resultID)) ?? [];
